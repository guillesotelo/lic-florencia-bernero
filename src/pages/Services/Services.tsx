    ...
    return (
        <div className="page__centered">
            <div className="privacy__container" style={{ width: isMobile ? '95%' : '50%', margin: '2rem' }}>
                ...
                <h2 id='psicoterapia'>Psicoterapia online</h2>
                ...
                <div id='entrenamiento-en-habilidades' style={{ margin: '4rem 0', borderBottom: '1px solid lightgray' }}></div>

                <h2>Entrenamiento en Habilidades Online</h2>
                ...
                <div id='valoraciones-neurocognitivas' style={{ margin: '4rem 0', borderBottom: '1px solid lightgray' }}></div>

                <h2>Valoraciones Neurocognitivas (Online)</h2>
